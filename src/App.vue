<template>
  <div id="gradient">
    <a
      href="https://github.com/yaohuangguan/color-generator"
      class="github-corner"
    ...
    >
      <svg
        ...
        height="80"
        viewBox="0 0 250 250"
        style="fill:#222222; color:#fff; position: absolute; top: 0; border: 0; right: 0;"
        aria-hidden="true"
      >
...
export default {
  ...
  methods: {
    ...
    setGradient() {
      ...
      left.innerHTML = "First Input Hexcode: " + color_1.value;
      right.innerHTML = "Second Input Hexcode: " + color_2.value;
